...
class InflatedConv3d(nn.Conv2d):
    def __init__(self, in_channels, out_channels, kernel_size, temporal_kernel_size=None, **kwargs):
        super(InflatedConv3d, self).__init__(in_channels, out_channels, kernel_size, **kwargs)
        ...
        if self.conv_temp is not None:
            nn.init.dirac_(self.conv_temp.weight.data)  # initialized to be identity
    ...
    def forward(self, x):
        ...
        if self.conv_temp is None or not is_video:
            return x
